...
export default function ConsultationHistoryPage() {
  const { sessions, isLoading, error, reload } = useSessionHistory();
              ...
              {sessions.map((session) => (
                <li key={session.id}>
                  <Link
                    ...
                    className="group flex items-center justify-between gap-4 px-4 py-3.5 transition-colors hover:bg-healia-brand-light/40 md:px-5"
                  >
